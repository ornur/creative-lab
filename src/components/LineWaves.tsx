...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    // 2. Initialize Geometry and Program (using const)
    ...
    // 3. Define Resize (now it can safely reference 'program')
    function resize() {
    ...
    // 4. Set up listeners and initial state
    window.addEventListener("resize", resize);
    resize(); // Call once immediately to sync sizes
